	...
	$(function(){
		$('#mod').submit(function(event){
			...
			$.ajax({
				type: "post",
				async: false,
				url: "<c:url value='/adminModifyProduct' />",
				data : formData,
				processData: false,
				contentType: false,
				success:function() {
...
<div class="mainDiv">
	...
	<div align="center">
		<form id="mod" enctype="multipart/form-data">
			<table border="1" >
				<colgroup>
					<col width="20%">
					<col width="80%">
				...
				<thead>
					<tr>
						<td colspan="2">
							상품 수정
							<input type="hidden" name = "num" value="${productModel.num }">
						</td>
				...
				<tbody>
					<tr>
						<td>상품이름</td>
						<td>
							<input type="text" name="name" value="${productModel.name }" />
						</td>
					</tr>
					...
					<tr>
						<td>상품가격</td>
						<td>
							<input type="text" name="price" value="${productModel.price }">원
						</td>
					</tr>
					...
					<tr>
						<td>상품설명</td>
						<td>
							<textarea rows="15" cols="50" name = "detail">${productModel.detail}</textarea>
						</td>
					</tr>
					...
					<tr>
						<td>상품수량</td>
						<td>
							<input type="text" name="stock" value="${productModel.stock }">개
						</td>
					</tr>
					...
					<tr>
						<td>상품이미지</td>
						<td>
							<img alt="" src="${contextPath }/img/${productModel.img }" height="100%" />
