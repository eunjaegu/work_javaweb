...
<body>
	<form name="boardModifyForm" action="<c:url value="/board/boardModfyServlet"/>" method="post" onsubmit="return boardModifyCheck();">
	...
	<table border="1" summary="게시판 수정 폼">
			...
			<tr>
				...
				<td><input type="text" name="writer" size="80" maxlength="20" value="<c:out value="${boardModel.writer}"/>"/></td>
			</tr>
			<tr>
				<td colspan="2">
